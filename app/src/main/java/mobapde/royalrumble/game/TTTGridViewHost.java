...
public class TTTGridViewHost extends View {
    ...
    public TTTGridViewHost(Context context, TicTacToe ticTacToe) {
        this(context, ticTacToe, null);
    }

    public TTTGridViewHost(Context context, final TicTacToe ticTacToe, AttributeSet attrs) {
        super(context, attrs);
        ...
        dr.child("tictactoe").child("player2pieces").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Player player = ticTacToe.getTurn(2);
...
//        x.draw(canvas);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            dr.child("tictactoe").child("player1pieces").child("x").setValue(x_place);
            dr.child("tictactoe").child("player1pieces").child("y").setValue(y_place);
